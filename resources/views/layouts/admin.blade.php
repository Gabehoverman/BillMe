...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../bulma/css/morris.css">
    <link rel="stylesheet" type="text/css" href="../bulma/css/admin.css">
</head>
<body>
<div class="columns">
...
<script type="text/javascript" src="../bulma/demo/jquery.js"></script>
<script type="text/javascript" src="../bulma/demo/raphael.min.js"></script>
<script type="text/javascript" src="../bulma/demo/morris.js"></script>
<script type="text/javascript" src="../bulma/demo/admin.js"></script>
</body>
</html>