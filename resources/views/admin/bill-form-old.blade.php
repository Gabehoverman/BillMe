...
@section('content')
    ...
    <h3><i class="fa fa-angle-right"></i> Submit Bill </h3>
    ...
    <div class="row mt">
        <div class="col-lg-12">
            <div class="form-panel">
                ...
                <form class="form-horizontal style-form" action="add-bill" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input name="month" id="month" type="month" class="form-control" value="{{$bill->month}}">
                        </div>
                        <div class="col-sm-4">
                            <label>Due Date</label>
                            <input name="due_date" id="due_date" type="date" class="form-control" value="{{$bill->due_date}}">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-4">
                            <label>Bill Amount</label>
                            <input name="amount" id="amount" type="text" class="form-control" value="{{$bill->amount}}">
                        </div>
                        <a class="btn btn-success" href="#" id="upload-image-button" value="{{$bill->image_url}}">Upload image of bill</a>
