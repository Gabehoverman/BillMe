                    ...
                    <div class="modal-dialog modal-lg">
                        ...
                        <div class="modal-body h-500">
                            ...
                            <div class="row mt-5">
                                ...
                                <div class="col-md-9">
                                    {this.props.state.modalMaintenance.user.first_name}.
                                </div>
                            </div>  
                            <hr />
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    { this.CheckCompletion(this.props.state.modalMaintenance.completed) }.
                                </div>
                            </div> 
                            <hr />
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                {moment(this.props.state.modalMaintenance.created_at).format("MMM Do YY") }.
                                </div>
                            </div> 
                            <hr />
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    {this.props.state.modalMaintenance.notes}.
                                </div>
                            </div> 
                            <hr />
                            </div>
                            ...
                            <Comments type="maintenance" item={this.props.state.modalMaintenance} state={this.state} />   
                            </div>
                        </div>
